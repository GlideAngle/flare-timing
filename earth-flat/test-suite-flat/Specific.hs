...
import qualified Flight.Flat.PointToPoint.Rational as Rat (distanceEuclidean)
import qualified Flight.Flat.Cylinder.Rational as Rat (circumSample)
...
specificUnits = testGroup "Zone edge shortest path unit tests"
    [ circumSampleUnits
    , forbesUnits
    ]
