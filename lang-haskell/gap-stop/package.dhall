        ...
        in  let testopts =
            ...
            in    defs
                ...
                ⫽ { flags.suppress-failing-tests
                  ...
                  , homepage = mkHome "lang-haskell/gap-stop#readme"
                  , synopsis = "GAP Scoring, Stopped"
                  , description =
                  ...
                  , tests =
                        ./../default-tests.dhall
                      ⫽ { stop =
                          { dependencies = testdeps # [ "flight-gap-stop" ]
                          , ghc-options = testopts
                          , main = "StopTestMain.hs"
                          , source-dirs = "test-suite-stop"
                          }
                        }
                  }
