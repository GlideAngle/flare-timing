...
in  let defs = ./../defaults.dhall
    ...
    in    defs
        ...
        ⫽ { name = "flight-kml"
          , homepage = mkHome "lang-haskell/kml#readme"
          , version = "1.1.0"
          ...
          , extra-source-files = defs.extra-source-files # [ "**/*.kml" ]
          , dependencies =
                defs.dependencies
              # [ "split"
                , "deepseq"
          ...
          , tests =
                ./../default-tests.dhall
              ⫽ { doctest =
                  { dependencies = [ "template-haskell", "doctest" ]
                  , ghc-options =
                ...
                , parse =
                  ...
                  , ghc-options =
                    [ "-rtsopts", "-threaded", "-with-rtsopts=-N" ]
                  , main = "Parse.hs"
                  , source-dirs = [ "library", "test-suite-parse" ]
                  }
                }
          }
