module FlareTiming.Task.VieScore.Speed (tableVieScoreSpeed) where
...
tableVieScoreSpeed
    ...
    -> m ()
tableVieScoreSpeed utcOffset hgOrPg _free sgs ln dnf' dfNt _vy vw _wg _pt _tp sDfs sAltFs = do
