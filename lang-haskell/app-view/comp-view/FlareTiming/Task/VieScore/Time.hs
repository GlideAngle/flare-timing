module FlareTiming.Task.VieScore.Time (tableVieScoreTime) where
...
tableVieScoreTime
    ...
    -> m ()
tableVieScoreTime _utcOffset hgOrPg _free sgs _ln dnf' dfNt _vy vw _wg pt _tp sDfs sAltFs = do
