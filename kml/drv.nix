...
let
  ...
  f = { mkDerivation, aeson, base, detour-via-sci, doctest
      , flight-clip, hxt, hxt-xpath, megaparsec, path, raw-strings-qq
      , siggy-chardust, smallcheck, split, stdenv, tasty, tasty-hunit
