...
let
  ...
  f = { mkDerivation, aeson, aeson-via-sci, base, bifunctors
      , flight-latlng, flight-sphere, flight-task, flight-units
      ...
      mkDerivation {
        ...
        libraryHaskellDepends = [
          aeson aeson-via-sci base bifunctors flight-latlng flight-sphere
          flight-task flight-units flight-zone hcoord numbers scientific
