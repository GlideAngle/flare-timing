...
import Flight.Score (NominalGoal(..), NominalDistance, Metres, isNormal)
...
distanceValidityUnits = testGroup "Distance validity unit tests"
    [ HU.testCase "Distance validity 0 0 0 0 0 0 == 0" $
        FS.distanceValidity (NominalGoal (0 % 1)) 0 0 0 0 0 @?= (0 % 1)

    , HU.testCase "Distance validity 1 1 1 1 1 1 == 1" $
        FS.distanceValidity (NominalGoal (1 % 1)) 1 1 1 1 1 @?= (1 % 1)

    , HU.testCase "Distance validity 1 0 1 1 1 1 == 1" $
        FS.distanceValidity (NominalGoal (1 % 1)) 0 1 1 1 1 @?= (1 % 1)

    , HU.testCase "Distance validity 1 1 0 1 1 1 == 0" $
        FS.distanceValidity (NominalGoal (1 % 1)) 1 0 1 1 1 @?= (0 % 1)

    , HU.testCase "Distance validity 1 1 1 0 1 1 == 1" $
        FS.distanceValidity (NominalGoal (1 % 1)) 1 1 0 1 1 @?= (1 % 1)

    , HU.testCase "Distance validity 1 1 1 1 0 1 == 0" $
        FS.distanceValidity (NominalGoal (1 % 1)) 1 1 1 0 1 @?= (0 % 1)

    , HU.testCase "Distance validity 1 1 1 1 1 0 == 0" $
        FS.distanceValidity (NominalGoal (1 % 1)) 1 1 1 1 0 @?= (0 % 1)
    ]
