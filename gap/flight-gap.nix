{ mkDerivation, aeson, aeson-via, aeson-via-uom, base, containers
, flight-units, hlint, newtype, scientific, siggy-chardust
, smallcheck, statistics, stdenv, tasty, tasty-hunit
, tasty-quickcheck, tasty-smallcheck, uom-plugin, vector
}:
mkDerivation {
  pname = "flight-gap";
  version = "0.1.0";
